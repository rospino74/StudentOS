...
INSERT INTO `users` 
	...
	VALUES 
		('1', 'administrator', 'Administrator', 'Administrator', 'test@test.com', PASSWORD('Administrator'), '0', '');
...
INSERT INTO `classrooms` (`id`, `name`, `members`, `can_students_post`) VALUES (NULL, 'class1', '{"teachers":["Administrator"],"students":[]}', '1');
/*Comments*/
